...
- {pin_num: '33', pin_signal: PIO0_7/ADC_0, label: POTE, identifier: POTE}
...
- pin_list:
  ...
  - {pin_num: '10', peripheral: SWD, signal: SWDIO, pin_signal: SWDIO/PIO0_2, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '48', peripheral: USART1, signal: RXD, pin_signal: PIO0_17/ADC_9/DACOUT_0}
  - {pin_num: '15', peripheral: USART1, signal: TXD, pin_signal: PIO0_16}
...
void BOARD_InitSWD_DEBUGPins(void)
{
    ...
    /* USART1_TXD connect to P0_16 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_TXD, kSWM_PortPin_P0_16);

    /* USART1_RXD connect to P0_17 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_RXD, kSWM_PortPin_P0_17);
