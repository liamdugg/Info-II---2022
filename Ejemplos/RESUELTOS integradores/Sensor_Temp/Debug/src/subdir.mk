...
clean-src:
	-$(RM) ./src/AP_FuncionesMDE.d ./src/AP_FuncionesMDE.o ./src/AP_Inicializacion.d ./src/AP_Inicializacion.o ./src/AP_MDE.d ./src/AP_MDE.o ./src/Sensor_Temp.d ./src/Sensor_Temp.o ./src/aeabi_romdiv_patch.o ./src/cr_startup_lpc84x.d ./src/cr_startup_lpc84x.o ./src/crp.d ./src/crp.o ./src/mtb.d ./src/mtb.o
