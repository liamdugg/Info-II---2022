...
outputs:
- {id: ADC_clock.outFreq, value: 18 MHz}
...
- {id: UART1_clock.outFreq, value: 18 MHz}
...
- {id: SYSCON.UART1CLKSEL.sel, value: SYSCON.FRO_DIRECT}
...
void BOARD_BootClockFRO18M(void)
{
    ...
    CLOCK_Select(kUART1_Clk_From_Fro);                     /*!< select FRO for UART1 */
